...
config_args = {
    'training_config': {
        ...
        'lambda-wasser': (1.0, 'lambda for additional loss term'),
        'lambda-uniform': (1.0, 'lambda for additional loss term'),
        'variant': ('DISTRIBUTION', 'JSGNN variants (DISTRIBUTION/PLAIN/MEAN/PAIRWISE)'),
    },
    'model_config': {
